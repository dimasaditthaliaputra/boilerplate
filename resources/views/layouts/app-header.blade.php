    ...
    <div class="flex flex-col items-center justify-between grow xl:flex-row xl:px-6">
        <div
            ...
            <button
                ...
                <svg x-show="$store.sidebar.isMobileOpen" x-cloak class="fill-current" width="24" height="24" viewBox="0 0 24 24"
            ...
            <a href="{{ route('dashboard') }}" class="xl:hidden">
                <span class="text-xl font-bold text-gray-900 dark:text-white">BMS Indonesia</span>
            </a>
            ...
            <div class="flex items-center gap-3">
                ...
                <div class="relative" x-data="{ open: false }">
                    <button @click="open = !open"
                        class="flex items-center justify-center w-10 h-10 overflow-hidden rounded-full bg-brand-500 text-white font-medium">
                        {{ strtoupper(substr(Auth::user()->name ?? 'U', 0, 1)) }}
                    </button>
                    <div x-show="open" @click.away="open = false" x-cloak
                        class="absolute right-0 mt-2 w-48 bg-white dark:bg-gray-800 rounded-lg shadow-theme-lg border border-gray-200 dark:border-gray-700 py-2">
                        <a href="#"
